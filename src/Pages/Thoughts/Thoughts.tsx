  ...
  return (
    ...
    >
      <div className="md:mt-4 px-3 text-yellow-600 text-xl flex-1 md:px-6">
        ...
        duonos kaina kas metus vidutiniškai pakildavo 11%. <br/><b>Paslaugos</b><br/> 1 m3 šalto
        ...
        bilieto kaina vidutiniškai pakildavo 1%. <br/><b>Apibendrinant</b><br/> Per 5 metus (2017
